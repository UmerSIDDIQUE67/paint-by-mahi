      ...
      <section className="hero-pattern relative overflow-hidden min-h-[85vh] flex items-center">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-linear-to-r from-stone-950/95 via-stone-900/80 to-transparent" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-amber-900/40 border border-amber-700/40 rounded-full px-4 py-1.5 text-amber-300 text-sm mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              Art That Speaks
              <span className="block text-gradient-gold">To Your Soul</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-amber-600/60 text-amber-300 hover:bg-amber-900/30 hover:border-amber-500"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={feature.title} className="flex items-center gap-3">
                <feature.icon className="w-8 h-8 text-amber-300 shrink-0" />
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-500 mt-3 max-w-xl mx-auto">
              Each piece is a unique original — no prints, no reproductions. Own a true work of art.
            </p>
          </div>
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className="group relative overflow-hidden rounded-xl bg-linear-to-br from-stone-100 to-stone-200 p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-stone-200"
                >
                  <div className="w-12 h-12 rounded-full bg-amber-100 group-hover:bg-amber-200 transition-colors flex items-center justify-center mx-auto mb-3">
                    <Icon className="w-6 h-6 text-amber-700" />
                  </div>
                  <h3 className="font-semibold text-stone-800 text-sm">{cat.name}</h3>
                  <p className="text-xs text-stone-500 mt-1">{cat.count} works</p>
      ...
      <section className="py-16 bg-stone-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-stone-300 text-lg mb-8 max-w-2xl mx-auto">
            Commission a custom painting — portraits, calligraphy, landscapes, or anything
            your imagination desires. Share your vision and Mahi will bring it to life.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Button asChild variant="gold" size="lg">
              <Link href="/custom-order">
                Request Custom Art <ArrowRight className="w-5 h-5" />
              </Link>
            </Button>
            <Button
              asChild
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl font-bold text-stone-800 mt-1">New Arrivals</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.step} className="text-center relative">
                <div className="text-5xl font-bold text-stone-100 mb-4 select-none">
                  {item.step}
                </div>
            ...
            {REVIEWS.slice(0, 6).map((review) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-stone-100">
                  <div className="w-9 h-9 rounded-full bg-amber-700 flex items-center justify-center text-white text-xs font-bold shrink-0">
                    {review.avatar}
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden bg-stone-100">
                <Image
                  ...
                  alt="Artist Mahi at work"
                  width={600}
                  height={600}
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute -bottom-4 -right-4 bg-amber-800 text-white rounded-xl px-5 py-3 shadow-lg">
                <div className="text-2xl font-bold">5+</div>
                <div className="text-xs text-amber-200">Years of Art</div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-stone-800 mt-2 mb-5">
                The Person Behind Every Brushstroke
              </h2>
              <p className="text-stone-600 leading-relaxed mb-4">
                Mahi is a passionate self-taught artist from Lahore, Pakistan, with over five
                years of experience creating original works in oil, watercolor, acrylic, and
                traditional calligraphy.
              </p>
              <p className="text-stone-600 leading-relaxed mb-6">
                Every painting is approached as a deeply personal expression — not just an
                image, but an experience. From capturing the sacred beauty of Islamic
                calligraphy to painting vivid Pakistani landscapes, each work carries a piece
                of Mahi&apos;s soul.
              </p>
